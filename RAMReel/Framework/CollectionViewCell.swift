...
open class RAMCell: UICollectionViewCell, ConfigurableCell {
    ...
    */
    ...
    fileprivate func setup() {
        ...
        let textLabelVConstraints = NSLayoutConstraint.constraints(withVisualFormat: "V:|[textLabel]|", options: NSLayoutFormatOptions.alignAllCenterY, metrics: nil, views: views) 
